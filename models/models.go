...
func RegisterDB() {
	...
	// db, err := sql.Open("mysql", "root:asdfASDF@tcp(localhost:8080)/xxl?charset=utf8")

	orm.RegisterDataBase("default", "mysql", "root:asdfASDF@tcp(localhost:3306)/xxl?charset=utf8&loc=Asia%2FShanghai", 30)
	// orm.RegisterDataBase("default", "mysql", "root:root@/orm_test?charset=utf8")
